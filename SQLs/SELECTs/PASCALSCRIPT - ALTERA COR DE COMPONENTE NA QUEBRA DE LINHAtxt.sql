// CÓDIGO QUE SERVE PARA UTILIZAR EM RELATÓRIOS FASTREPORT NA FOLHA, EM QUE MUDA A COR DE UM COMPONENTE MEMO AOTER VARIAS LINHAS NO RESULTADO NO RELATÓRIO
