---SQL TURNOVER PARA CRITÉRIOS DA PLR ---VERIFICANDO AJUSTE
                ...
                SELECT CON_CON.COD_CONTRATO,
                    ...
                    From RHFP0300 RHFP0300,
                         (
                            ...
                            FROM GRZ_FOLHA.RHFP0200@NLGZT Rhfp0200,
                                 GRZ_FOLHA.RHFP0300@NLGZT Rhfp0300,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_1,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_2,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_3,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_4,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_5,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_6,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_7,
                                 GRZ_FOLHA.PESSOA@NLGZT Pessoa_8,
                                 GRZ_FOLHA.RHFP0104@NLGZT Rhfp0104,
                                 GRZ_FOLHA.RHFP0105@NLGZT Rhfp0105,
                                 GRZ_FOLHA.RHFP0107@NLGZT Rhfp0107_1,
                                 GRZ_FOLHA.RHFP0107@NLGZT Rhfp0107_2,
                                 GRZ_FOLHA.RHFP0107@NLGZT Rhfp0107_3,
                                 GRZ_FOLHA.RHFP0107@NLGZT Rhfp0107_4,
                                 GRZ_FOLHA.MUNICI@NLGZT Munici_1,
                                 GRZ_FOLHA.UF@grzfolha Uf_1,
                                 GRZ_FOLHA.UF@grzfolha Uf_2,
                                 GRZ_FOLHA.UF@grzfolha Uf_3,
                                 GRZ_FOLHA.MUNICI@grzfolha Munici_3,
                                 GRZ_FOLHA.UF@grzfolha Uf_4,
                                 GRZ_FOLHA.RHFP0130@NLGZT Rhfp0130,
                                 GRZ_FOLHA.FISICA@NLGZT Fisica,
                                 GRZ_FOLHA.FISICA@NLGZT FISCONJ,
                                 GRZ_FOLHA.JURIDICA@grzfolha JURRNE,
                                 GRZ_FOLHA.PESSOA@NLGZT PESRNE,
                                 GRZ_FOLHA.Rhfp0132@NLGZT Rhfp0132,
                                 GRZ_FOLHA.Rhfp0139@NLGZT Rhfp0139,
                                 GRZ_FOLHA.Rhfp0145@NLGZT Rhfp0145,
                                 (SELECT COD_FUNC, COUNT(*) AS NRO_DEPENDENTES
                                    FROM GRZ_FOLHA.RHFP0202@NLGZT
                                   WHERE PI_DATA_REF BETWEEN
                         ...
                         (SELECT SALARIO.COD_CONTRATO,
                            ...
                            FROM (SELECT RHFP0608.COD_CONTRATO,
                                    ...
                                    FROM GRZ_FOLHA.RHFP0608@NLGZT RHFP0608,
                                         GRZ_FOLHA.RHFP0605@NLGZT RHFP0605,
                                         GRZ_FOLHA.RHFP0606@NLGZT RHFP0606,
                                         GRZ_FOLHA.RHFP0600@NLGZT RHFP0600_FAIXA,
                                         GRZ_FOLHA.RHFP0600@NLGZT RHFP0600_NIVEL,
                                         GRZ_FOLHA.RHFP0601@NLGZT RHFP0601,
                                         GRZ_FOLHA.RHFP0602@NLGZT RHFP0602,
                                         GRZ_FOLHA.RHFP0323@NLGZT RHFP0323,
                                         GRZ_FOLHA.RHFP0115@NLGZT RHFP0115,
                                         GRZ_FOLHA.RHFP0118@NLGZT RHFP0118
                                   WHERE RHFP0608.COD_INF_SALARIAL = 3
                                     AND PI_DATA_REF BETWEEN
                                  ...
                                  SELECT RHFP0608.COD_CONTRATO,
                                         ...
                                         DECODE(RHFP0608.TIPO_SALARIO,
                                                ...
                                                '') AS NOME_TIPO_SALARIO
                                    FROM GRZ_FOLHA.RHFP0608@NLGZT RHFP0608,
                                         GRZ_FOLHA.RHFP0607@NLGZT RHFP0607,
                                         GRZ_FOLHA.RHFP0606@NLGZT RHFP0606,
                                         GRZ_FOLHA.RHFP0605@NLGZT RHFP0605,
                                         GRZ_FOLHA.RHFP0600@NLGZT RHFP0600_FAIXA,
                                         GRZ_FOLHA.RHFP0600@NLGZT RHFP0600_NIVEL,
                          ...
                          SELECT VDS.COD_CONTRATO,
                            ...
                            FROM (SELECT FIN.COD_CONTRATO,
                                     ...
                                     FROM (SELECT RHFP1005.COD_CONTRATO,
                                                  ...
                                                  MESTRE.NOME_EVENTO
                                             FROM GRZ_FOLHA.RHFP1005@NLGZT RHFP1005,
                                                  (SELECT RHFP1003.COD_MESTRE_EVENTO,
                                                     ...
                                                     FROM GRZ_FOLHA.RHFP1003@NLGZT RHFP1003,
                                                          GRZ_FOLHA.RHFP1002@NLGZT RHFP1002
                                                    WHERE RHFP1003.SITUACAO_PROCESSO = 'C'
                                                      AND RHFP1003.COD_EVENTO =
                                                          RHFP1002.COD_EVENTO
                                                      AND RHFP1003.DATA_REFERENCIA BETWEEN
                                                          '01/01/' ||
                                                          substr(PI_DATA_REF, 7, 4) AND
                                                          PI_DATA_REF) MESTRE
                                           ...
                                           SELECT RHFP1006.COD_CONTRATO,
                                                  ...
                                                  MESTRE.NOME_MESTRE_EVENTO,
                                                  MESTRE.NOME_EVENTO
                                             FROM GRZ_FOLHA.RHFP1006@NLGZT RHFP1006,
                                                  (SELECT RHFP1003.COD_MESTRE_EVENTO,
                                                          RHFP1003.DATA_REFERENCIA,
                                                          RHFP1003.COD_EVENTO,
                                                          RHFP1003.DATA_PAGAMENTO,
                         ...
                         (SELECT RHFP0340.COD_CONTRATO,
                            ...
                            FROM GRZ_FOLHA.RHFP0300@NLGZT RHFP0300,
                                 GRZ_FOLHA.RHFP0340@NLGZT RHFP0340,
                                 GRZ_FOLHA.RHFP0323@NLGZT RHFP0323,
                                 GRZ_FOLHA.RHFP0115@NLGZT RHFP0115,
                                 GRZ_FOLHA.RHFP0500@NLGZT RHFP0500,
                                 GRZ_FOLHA.RHFP0103@NLGZT RHFP0103,
                                 GRZ_FOLHA.RHFP0137@NLGZT RHFP0137,
                                 GRZ_FOLHA.RHFP0514@NLGZT RHFP0514,
                                 GRZ_FOLHA.RHFP0609@NLGZT RHFP0609,
                                 GRZ_FOLHA.RHCS0530@NLGZT,
                                 GRZ_FOLHA.RHCS0196@NLGZT
                           WHERE RHFP0340.COD_MOTIVO = RHFP0323.COD_MOTIVO(+)
                             ...
                             AND PI_DATA_REF BETWEEN RHFP0340.DATA_INICIO AND
                         ...
                         (SELECT RHFP0300.COD_CONTRATO,
                                 ...
                                 PI_DATA_REF AS DATA_REFERENCIA,
                            ...
                            FROM GRZ_FOLHA.PESSOA@NLGZT   PESSOA_BCO_PGTO,
                                 GRZ_FOLHA.PESSOA@NLGZT   PESSOA_AGE_PGTO,
                                 GRZ_FOLHA.PESSOA@NLGZT   PESSOA_BCO_FGTS,
                                 GRZ_FOLHA.PESSOA@NLGZT   PESSOA_AGE_FGTS,
                                 GRZ_FOLHA.RHFP0300@NLGZT RHFP0300,
                                 GRZ_FOLHA.BANCO@NLGZT   BANCO_PGTO,
                                 GRZ_FOLHA.AGENCIA@NLGZT  AGENCIA_PGTO,
                                 GRZ_FOLHA.BANCO@NLGZT   BANCO_FGTS,
                                 GRZ_FOLHA.AGENCIA@NLGZT  AGENCIA_FGTS,
                                 GRZ_FOLHA.RHFP0102@NLGZT RHFP0102,
                                 GRZ_FOLHA.RHFP0239@NLGZT RHFP0239,
                                 GRZ_FOLHA.RHFP0110@NLGZT RHFP0110,
                                 GRZ_FOLHA.RHFP0114@NLGZT RHFP0114,
                                 GRZ_FOLHA.RHFP0112@NLGZT RHFP0112,
                                 GRZ_FOLHA.RHFP0111@NLGZT RHFP0111,
                                 GRZ_FOLHA.RHFP0116@NLGZT RHFP0116,
                                 GRZ_FOLHA.RHFP0113@NLGZT RHFP0113,
                                 GRZ_FOLHA.RHFP0128@NLGZT RHFP0128,
                                 GRZ_FOLHA.RHFP0804@NLGZT RHFP0804,
                                 GRZ_FOLHA.RHAF1112@NLGZT RHAF1112,
                                 GRZ_FOLHA.RHCS0196@NLGZT RHCS0196
                           WHERE RHFP0300.COD_CAUSA_DEMISSAO =
                             ...
                             AND PI_DATA_REF BETWEEN RHAF1112.DATA_INICIO(+) AND
                                 RHAF1112.DATA_FIM(+)
                             AND RHFP0300.COD_CONTRATO =
                         ...
                         (
                            ...
                            FROM GRZ_FOLHA.RHFP0306@NLGZT RHFP0306,
                                 GRZ_FOLHA.RHFP0300@NLGZT RHFP0300
                           WHERE RHFP0300.COD_CONTRATO =
                                 RHFP0306.COD_CONTRATO(+)
                             AND PI_DATA_REF BETWEEN RHFP0306.DATA_INICIO(+) AND
                                 RHFP0306.DATA_FIM(+)
                                 ) CON_STAAFA,
                         (
                            ...
                            FROM GRZ_FOLHA.RHFP0310@NLGZT RHFP0310,
                                 GRZ_FOLHA.RHFP0401@NLGZT RHFP0401,
                                 GRZ_FOLHA.RHFP0400@NLGZT EMP400,
                                 GRZ_FOLHA.RHFP0400@NLGZT FIL400,
                                 GRZ_FOLHA.RHFP0400@NLGZT N4,
                                 GRZ_FOLHA.RHFP0400@NLGZT N5,
                                 GRZ_FOLHA.RHFP0400@NLGZT N6,
                                 GRZ_FOLHA.RHFP0400@NLGZT N7,
                                 GRZ_FOLHA.RHFP0400@NLGZT N8,

                                 GRZ_FOLHA.PESSOA@NLGZT PESEMP,
                                 GRZ_FOLHA.PESSOA@NLGZT PESFIL,
                                 GRZ_FOLHA.PESSOA@NLGZT PESN04,
                                 GRZ_FOLHA.PESSOA@NLGZT PESN05,
                                 GRZ_FOLHA.PESSOA@NLGZT RESPEMP,
                                 GRZ_FOLHA.PESSOA@NLGZT RESPFIL,

                                 GRZ_FOLHA.LOGRA@NLGZT   LOGEMP,
                                 GRZ_FOLHA.JURIDICA@grzfolha JUREMP,
                                 GRZ_FOLHA.MUNICI@grzfolha   MUNEMP,
                                 GRZ_FOLHA.BAIRRO@NLGZT   BAIEMP,

                                 GRZ_FOLHA.LOGRA@NLGZT   LOGFIL,
                                 GRZ_FOLHA.JURIDICA@grzfolha JURFIL,
                                 GRZ_FOLHA.MUNICI@grzfolha   MUNFIL,
                                 GRZ_FOLHA.BAIRRO@NLGZT   BAIFIL,

                                 GRZ_FOLHA.LOGRA@NLGZT   LOGN4,
                                 GRZ_FOLHA.JURIDICA@grzfolha JURN4,
                                 GRZ_FOLHA.MUNICI@grzfolha   MUNN4,
                                 GRZ_FOLHA.BAIRRO@NLGZT   BAIN4,

                                 GRZ_FOLHA.LOGRA@NLGZT   LOGN5,
                                 GRZ_FOLHA.JURIDICA@grzfolha JURN5,
                                 GRZ_FOLHA.MUNICI@grzfolha   MUNN5,
                                 GRZ_FOLHA.BAIRRO@NLGZT   BAIN5,

                                 GRZ_FOLHA.RHFP0430@NLGZT R430EMP,
                                 GRZ_FOLHA.RHFP0430@NLGZT R430FIL,

                                 GRZ_FOLHA.BANCO@NLGZT  BANEMP,
                                 GRZ_FOLHA.AGENCIA@NLGZT AGEEMP,
                                 GRZ_FOLHA.BANCO@NLGZT  BANFIL,
                                 GRZ_FOLHA.AGENCIA@NLGZT AGEFIL,

                                 GRZ_FOLHA.PESSOA@NLGZT PESBANEMP,
                                 GRZ_FOLHA.PESSOA@NLGZT PESBANFIL,
                                 GRZ_FOLHA.PESSOA@NLGZT PESAGEEMP,
                                 GRZ_FOLHA.PESSOA@NLGZT PESAGEFIL,
                                 GRZ_FOLHA.RHFP0323@NLGZT RHFP0323,
                                 (
                                    SELECT RHFP0310.COD_CONTRATO,
                                         RHFP0310.DATA_INICIO,
                                   ...
                                   WHERE RHFP0310.COD_ORGANOGRAMA =
                                     ...
                                     AND JUREMP.COD_LOGRA =
                                         LOGEMP.COD_LOGRA(+)
                                     AND JUREMP.COD_MUNIC =
                                         LOGEMP.COD_MUNIC(+)
                                     ...
                                     AND JURFIL.COD_LOGRA =
                                         LOGFIL.COD_LOGRA(+)
                                     AND JURFIL.COD_MUNIC =
                                         LOGFIL.COD_MUNIC(+)
                           ...
                           WHERE RHFP0310.COD_ORGANOGRAMA =
                                 RHFP0401.COD_ORGANOGRAMA
                             AND PI_DATA_REF BETWEEN RHFP0401.DATA_INICIO AND
                                 RHFP0401.DATA_FIM
                             AND PI_DATA_REF BETWEEN RHFP0310.DATA_INICIO AND
                                 RHFP0310.DATA_FIM
                         ...
                         (
                            ...
                            FROM (SELECT CTR.COD_CONTRATO,
                                         ...
                                         SUBSTR(GRZ_FOLHA.RHYF0034@NLGZT(RHFP0402.COD_CUSTO_CONTABIL,
                                                                  1,
                                                                  'E'),
                                                1,
                                    ...
                                    FROM GRZ_FOLHA.RHFP0402@NLGZT RHFP0402,
                                         GRZ_FOLHA.RHFP0402@NLGZT CS,
                                         (SELECT RHFP0310.COD_CONTRATO,
                                                 RHFP0400.COD_CUSTO_CONTABIL,
                                                 RHFP0310.DATA_INICIO,
                                                 RHFP0310.DATA_FIM
                                            FROM GRZ_FOLHA.RHFP0310@NLGZT RHFP0310,
                                                 GRZ_FOLHA.RHFP0400@NLGZT RHFP0400
                                           WHERE RHFP0310.COD_ORGANOGRAMA =
                                             ...
                                             AND RHFP0310.COD_CONTRATO NOT IN
                                                 (SELECT RHFP0313.COD_CONTRATO
                                                    FROM GRZ_FOLHA.RHFP0313@NLGZT RHFP0313
                                                   WHERE PI_DATA_REF BETWEEN
                         ...
                         (
                            ...
                            FROM (SELECT COD_CONTRATO, 0 AS STATUS
                                   ...
                                   WHERE (RHFP0300.DATA_FIM IS NULL OR
                                         RHFP0300.DATA_FIM >= PI_DATA_REF)
                                     AND (RHFP0300.DATA_INICIO <= PI_DATA_REF)
                                  UNION ALL
                                  ...
                                  SELECT COD_CONTRATO, 1 AS STATUS
                                    FROM GRZ_FOLHA.RHFP0300@NLGZT RHFP0300
                                   WHERE (RHFP0300.DATA_INICIO > PI_DATA_REF)) STACON
                         ...
                         (
                            ...
                            FROM GRZ_FOLHA.RHFP0310@NLGZT RHFP0310,
                                 GRZ_FOLHA.RHFP0400@NLGZT RHFP0400,
                                 GRZ_FOLHA.RHFP0401@NLGZT RHFP0401,
                                 GRZ_FOLHA.PE0002@NLGZT   PE0002,
                                 GRZ_FOLHA.PE0001@NLGZT   PE0001
                           WHERE RHFP0310.COD_ORGANOGRAMA =
                                 RHFP0401.COD_ORGANOGRAMA
                             AND PI_DATA_REF BETWEEN RHFP0310.DATA_INICIO AND
                                 RHFP0310.DATA_FIM
                         ...
                         (
                            ...
                            SELECT RHFP0310.COD_CONTRATO,
                                 ...
                                 SUBSTR(GRZ_FOLHA.RHYF0002@NLGZT(RHFP0310.COD_ORGANOGRAMA,
                            ...
                            FROM GRZ_FOLHA.RHFP0310@NLGZT RHFP0310,
                                 ...
                                 GRZ_FOLHA.RHFP0115@NLGZT RHFP0115,
                                 GRZ_FOLHA.RHFP0102@NLGZT RHFP0102,
                                 GRZ_FOLHA.RHFP0402@NLGZT RHFP0402,
                                 GRZ_FOLHA.RHFP0401@NLGZT RHFP0401,
                                 GRZ_FOLHA.RHFP0436@NLGZT RHFP0436,
                                 GRZ_FOLHA.RHFP3170@NLGZT RHFP3170,
                                 GRZ_FOLHA.PESSOA@NLGZT PESSOA_DRT,
                                 GRZ_FOLHA.PESSOA@NLGZT PESSOA_EMPFIL,
                                 GRZ_FOLHA.RHFP0117@NLGZT RHFP0117,
                                 GRZ_FOLHA.RHFP0397@NLGZT ORESP,
                                 (
                           ...
                           WHERE RHFP0310.COD_ORGANOGRAMA =
                             ...
                             AND PI_DATA_REF BETWEEN ORESP.DATA_INICIO(+) AND
                                 ORESP.DATA_FIM(+)
                   ...
                   Where RHFP0300.COD_CONTRATO = CON_EMP.COD_CONTRATO(+)
                     ...
                     AND (CON_STACON.STATUS_CONTRATO IN (0, 1) AND
                         ((CON_CUSTO.EDICAO_NIVEL3 = wRede and
                         PI_REDE <> 70) OR (PI_REDE = 70)) AND
                         CON_EMP.EDICAO_FILIAL = wFilial AND
