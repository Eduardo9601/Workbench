SELECT CON_EMP.COD_NIVEL5 AS COD_ORGANOGRAMA
,CON_EMP.EDICAO_FILIAL
,CON_ORG.NOME_ORGANOGRAMA
,CON_CUSTO.EDICAO_NIVEL5 AS CUSTO_UNIDADE
,CON_ORG.EDICAO_ORGANOGRAMA
,CON_EMP.EDICAO_EMPRESA
,CON_ORG.DATA_FIM_ORG
,CON_EMP.CGC_FILIAL
,CON_EMP.DDD_FILIAL
,CON_EMP.FONE_FILIAL
,CON_EMP.CEP_FILIAL
...
Where RHFP0300.COD_CONTRATO = CON_EMP.COD_CONTRATO(+)
 ...
 AND CON_STAAFA.STATUS_AFASTAMENTO = '0'
 )
...
Group by CON_STAAFA.STATUS_AFASTAMENTO
...
Where RHFP0300.COD_CONTRATO = CON_EMP.COD_CONTRATO(+)
 ...
 CON_STACON.STATUS_CONTRATO = 0
 AND CON_STAAFA.STATUS_AFASTAMENTO = '0'
 AND CON_EMP.EDICAO_FILIAL NOT IN ('001','013')
 ) 
AND ( RHFP0300.COD_CONTRATO IN (SELECT COD_CONTRATO FROM RHFP0310 WHERE :DATA_REFERENCIA BETWEEN DATA_INICIO AND DATA_FIM AND (COD_ORGANOGRAMA IN (
8
,9
