CREATE OR REPLACE VIEW V_DADOS_COLAB_AVT_ANT AS
...
SELECT
    ...
    -- DADOS DO TURNO E HORÁRIOS DO CONTRATO
     ...
     WHERE (CT.DATA_FIM IS NULL AND SYSDATE BETWEEN CT.DATA_INICIO AND
           NVL(CT.DATA_FIM, TO_DATE('31/12/2999', 'DD/MM/YYYY')) OR
           CT.DATA_FIM >= SYSDATE - 365)
