...
BEGIN
  DECLARE
    ...
    wDataMovimento DATE;--VARCHAR2(10); -- := to_char((sysdate - 60), 'mm/yyyy');
    wAno NUMBER;
  ...
  begin
    ...
    wAno := to_number(to_char(wDataMovimento,'YYYY'));
        ...
        begin
          select inventario_max
           ...
           where rede = r_insereUnidade.cod_rede
             and ano = wAno;--substr(wDataMovimento, 7, 4);
        end;
