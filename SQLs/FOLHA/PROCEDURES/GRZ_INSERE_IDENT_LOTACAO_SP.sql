  ...
  LEFT JOIN (SELECT COD_UNIDADE, COD_FUNCAO, IND_RESP_UNI
              ...
              WHERE COD_EMP = '008'
                ...
                AND IND_RESP_UNI = 'S') SS3 ON SS1.EDICAO_QL =
                                               SS3.COD_UNIDADE) LOOP
    INSERT INTO RHFP0510
      (COD_LOTACAO, DATA_INICIO, DATA_FIM, COD_ORGANOGRAMA, COD_CLH, COD_TURNO, NUM_VAGAS, NUM_HORAS, COD_MOTIVO, OBSERVACOES, VLR_PREMIO, VLR_CESTA)
    VALUES
      (REC.COD_LOTACAO,
       REC.DATA_INICIO,
       REC.DATA_FIM,
