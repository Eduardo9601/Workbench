...
SELECT 0 AS ORDEM,
       ...
       NULL AS DES_PESSOA,
       NULL AS DES_FUNCAO,
       'PERÍODOS JÁ VENCIDOS' AS DES_UNIDADE,
       NULL AS AFASTAMENTO,
       NULL AS PERIODO,
       NULL AS DIAS,
       NULL AS STATUS,
       NULL AS ULTIMAS_FERIAS,
       NULL AS DIAS_REALIZADO
FROM DUAL
...
SELECT 1 AS ORDEM,
       ...
       DES_FUNCAO,
       DES_UNIDADE,
       DES_AFAST AS AFASTAMENTO,
       VENC_PERIODO_AQUISITIVO AS PERIODO,
       VENC_DIAS_ATRASO AS DIAS,
       VENC_STATUS_PERIODO AS STATUS,
       ULTIMAS_FERIAS,
       ULT_DIAS_REALIZADO AS DIAS_REALIZADO
FROM RESULTADO
WHERE VENC_STATUS_PERIODO = 'VENCIDO'
...
SELECT 2 AS ORDEM,
       ...
       NULL AS DES_PESSOA,
       NULL AS DES_FUNCAO,
       'PERÍODOS EM ABERTO' AS DES_UNIDADE,
       NULL AS AFASTAMENTO,
       NULL AS PERIODO,
       NULL AS DIAS,
       NULL AS STATUS,
...
SELECT 3 AS ORDEM,
       ...
       DES_UNIDADE,
       DES_AFAST AS AFASTAMENTO,
       ABER_PERIODO_AQUISITIVO AS PERIODO,
       ABER_DIAS_FALTAM AS DIAS,
       ABER_STATUS_PERIODO AS STATUS,
       ULTIMAS_FERIAS,
       ULT_DIAS_REALIZADO AS DIAS_REALIZADO
FROM RESULTADO
WHERE ABER_DIAS_FALTAM <= 90
...
SELECT 4 AS ORDEM,
       ...
       NULL AS DES_PESSOA,
       NULL AS DES_FUNCAO,
       'FÉRIAS PROGRAMADAS' AS DES_UNIDADE,
       NULL AS AFASTAMENTO,
       NULL AS PERIODO,
       NULL AS DIAS,
       NULL AS STATUS,
...
SELECT 5 AS ORDEM,
       ...
       DES_UNIDADE,
       DES_AFAST AS AFASTAMENTO,
       PROXIMAS_FERIAS AS PERIODO,
       PROX_DIAS_CONCED AS DIAS,
       'PROGRAMADO' AS STATUS,
       ULTIMAS_FERIAS,
       ULT_DIAS_REALIZADO AS DIAS_REALIZADO
FROM RESULTADO
WHERE PROXIMAS_FERIAS IS NOT NULL
