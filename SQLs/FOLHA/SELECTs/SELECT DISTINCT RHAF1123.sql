SELECT DISTINCT RHAF1123.COD_CONTRATO,
 ...
 WHERE RHAF1123.COD_OCORRENCIA = RHAF1129.COD_OCORRENCIA
   ...
   AND RHAP1145.DATA_INICIO = RHAF1138.DATA_INICIO
   ...
   AND SYSDATE BETWEEN RHFP0310.DATA_INICIO AND RHFP0310.DATA_FIM
   AND ORG.COD_EMP = 8
