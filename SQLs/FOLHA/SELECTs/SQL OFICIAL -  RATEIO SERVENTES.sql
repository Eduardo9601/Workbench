...
CONTRATOS AS (
  SELECT DISTINCT CT.STATUS,
   ...
   WHERE (CT.DATA_DEMISSAO IS NULL OR
     ...
     AND TO_DATE('30/09/2025', 'DD/MM/YYYY') BETWEEN ORG.DATA_INI_ORG AND ORG.DATA_FIM_ORG
     AND TO_DATE('30/09/2025', 'DD/MM/YYYY') BETWEEN FN.DATA_INI_CLH AND FN.DATA_FIM_CLH
     AND TO_DATE('30/09/2025', 'DD/MM/YYYY') BETWEEN HR.DATA_INI_HR AND HR.DATA_FIM_HR
     AND ORG.COD_EMP = 8
...
/*VERSÃO DE GERAÇÃO E SALVAMENTO NAS SELEÇÕES DO SISTEMA NA FOLHA - SEL0073*/
