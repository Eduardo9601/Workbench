SELECT DISTINCT CT.COD_UNIDADE,  
 LJ.NOME_LOJA AS DES_UNIDADE,  
 PS.DES_PESSOA AS "PROPRIETÁRIO",  
 CASE  
 WHEN (PS.NUM_TELEFONE IS NOT NULL OR  
 PS.NUM_TELEFONE IS NULL) THEN  
 '(54) 9 9999-9999'  
 END AS TELEFONE,  
 CASE  
 ...
 INNER JOIN NL.GE_GRUPOS_UNIDADES GE ON GE.COD_UNIDADE = CT.COD_UNIDADE  
 WHERE GE.COD_GRUPO = 999  