...
SELECT CASE
       ...
       B.EMAIL_ALTER,
       C.COD_PESSOA_PAI,
       B1.NOME_PESSOA AS DES_PAI,
       C.COD_PESSOA_MAE,
       B2.NOME_PESSOA AS DES_MAE,
       C.COD_ESTADO_CIVIL,
  ...
  LEFT JOIN PESSOA_FISICA B1 ON C.COD_PESSOA_PAI = B1.COD_PESSOA
  LEFT JOIN PESSOA_FISICA B2 ON C.COD_PESSOA_MAE = B2.COD_PESSOA
