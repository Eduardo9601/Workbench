...
SELECT DISTINCT A.COD_CONTRATO,
       ...
       CASE 
           WHEN D.COD_NIVEL2 = 4 THEN 'MUNDIART SA'
           WHEN D.COD_NIVEL2 = 6 THEN 'GRATO LTDA'
           WHEN D.COD_NIVEL2 = 8 THEN 'GRAZZIOTIN SA'
           WHEN D.COD_NIVEL2 = 276 THEN 'CENTRO SHOPPING LTDA'
           WHEN D.COD_NIVEL2 = 282 THEN 'GRAZZIOTIN FINANCEIRA'
           WHEN D.COD_NIVEL2 = 1629 THEN 'FLORESTA LTDA'
           ELSE NULL
       END AS DES_EMPRESA
FROM RHFP0300 A
