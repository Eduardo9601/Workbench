...
SELECT CASE
 ...
 INNER JOIN PESSOA_FISICA B ON A.COD_FUNC = B.COD_PESSOA
  ...
  LEFT JOIN RHFP0344 H ON H.COD_CONTRATO = A.COD_CONTRATO
                      AND H.DATA_FIM = '31/12/2999'
  LEFT JOIN RHFP0323 I ON I.COD_MOTIVO = H.COD_MOTIVO
  LEFT JOIN RHFP0304 J ON J.COD_CONTRATO = A.COD_CONTRATO
...
SELECT A.COD_FUNC,
       ...
       CASE
         WHEN I.EMAIL LIKE '%grazziotin.com.br%'
           OR I.EMAIL LIKE '%grupograzziotin.com.br%'
           OR I.EMAIL LIKE '%tottal.com.br%'
           OR I.EMAIL LIKE '%pormenos.com.br%'
           OR I.EMAIL LIKE '%gztstore.com.br%'
           OR I.EMAIL LIKE '%francogiorgi.com.br%'
         THEN I.EMAIL     -- OU EMAIL, SE ESSA FOR A COLUNA CERTA
         ELSE NULL
       END AS DES_EMAIL,
 ...
 FROM RHFP0200 A
  ...
  LEFT JOIN RHFP0161 E1 ON E1.COD_PAIS = E.COD_ESOCIAL
 ...
 INNER JOIN PESSOA_FISICA I ON A.COD_FUNC = I.COD_PESSOA
  LEFT JOIN MUNICI J1 ON J1.COD_MUNIC = I.COD_MUNIC
  LEFT JOIN MUNICI J2 ON J2.COD_MUNIC = A.COD_MUNIC_NASCIMENTO
...
SINDICATO AS (
  SELECT *
  FROM (
    SELECT COD_CONTRATO, COD_SINDICATO, DES_SINDICATO, IND_CONT_SINDICAL,
           DATA_INICIO AS DATA_INI_SIND, DATA_FIM AS DATA_FIM_SIND,
