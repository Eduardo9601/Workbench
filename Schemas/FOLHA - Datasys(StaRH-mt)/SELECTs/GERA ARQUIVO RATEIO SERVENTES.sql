/*VERSÃO OFICIAL DE GERAÇÃO*/

/*LEMBRAR DE SEMPRE MUDAR OS PARÂMETROS DE DATAS PARA GERAR CONFORME O MÊS COMPETENTE*/

-- ===== sessão =====
-- sessão: nada além do SELECT vai para o arquivo
SET ECHO OFF
SET VERIFY OFF
SET HEADING OFF
SET FEEDBACK OFF
...
SET NEWPAGE 0
SET TRIMSPOOL OFF
COLUMN LINHA_ERP FORMAT A326

-- ===== spool =====
SPOOL P:\nlcomum\INTERFAC\CONTABILIDADE\TESTESERVENTE.TXT
