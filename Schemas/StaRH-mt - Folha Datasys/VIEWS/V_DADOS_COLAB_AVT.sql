...
CONTRATOS AS (
  SELECT DISTINCT
         ...
         /* NOME CURTO COM INICIAIS DOS NOMES DO MEIO, IGNORANDO DA/DE/DO/DAS/DOS/E, M�X. 40 CHARS */
         SUBSTR(
           CASE
             WHEN TRIM(
                    REGEXP_REPLACE(
...
DADOS_PESSOAIS AS (
  SELECT DISTINCT A.COD_FUNC,
                  ...
                  J2.COD_MUN_FED AS COD_IBGE_NASCTO,
                  A.COD_UF_NASCIMENTO,
                  A.COD_PAIS_NASCTO,
                  A.IND_REG_CONSELHO,
                  I.CEP AS COD_CEP,
    ...
    LEFT JOIN RHFP0161 E1
      ON E1.COD_PAIS = E.COD_ESOCIAL
...
/* DADOS DO CONTRATO */
 ...
 CT.DATA_AVANCO,
 CT.DATA_ADMISSAO,
 CT.COD_TIPO_ADMISSAO,
 CT.DES_TIPO_ADMISSAO,
 CT.DATA_DEMISSAO,
 CT.COD_DEMISSAO,
 CT.DES_DEMISSAO,
 CT.NRO_CONTA_PGTO,
 ...
 /*HOR�RIOS DA ESCALA DE TRABALHO*/
 HR.DATA_INICIO_HOR,
 HR.DATA_FIM_HOR,
 HR.HOR_1_ENT,
 HR.HOR_1_SAI,
 ...
 /*DADOS ANTERIORES DO COLABORDOR - �LTIMO ANTES DO ATUAL NA REFER�NCIA*/
