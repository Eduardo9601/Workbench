...
SELECT RHFP0300.COD_CONTRATO COD_FUNCIONARIO,
       CASE
           WHEN ORG_EMP.COD_NIVEL2 = 282 THEN
             '282'
           ELSE 
             ORG_EMP.EDICAO_ORG 
       ...
       ORG_EMP.COD_ORGANOGRAMA_SUB,
       CONTR_ORGANOGRAMA.COD_NIVEL2 COD_EMPRESA,
       CASE
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 8 THEN
          'GRAZZIOTIN'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 4 THEN
          'MUNDIART'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 276 THEN
          'CENTRO SHOPPING'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 280 THEN
          'CAULESPAR'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 282 THEN
          'FINANCIADORA'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 2 THEN
          'VR'
         WHEN CONTR_ORGANOGRAMA.COD_NIVEL2 = 6 THEN
          'GRATO'
         ELSE
          'GRAZZIOTIN'
       END DES_EMPRESA,
       ...
       CASE
         WHEN FUNCOES.COD_CLH = 325 THEN
          RHFP0300.COD_CONTRATO || '@grupograzziotin.com.br'
         ELSE
          RHFP0300.COD_CONTRATO || '@grazziotin.com.br'
       END EMAIL,
       CASE
         WHEN ((UPPER(FUNCOES.NOME_CLH) LIKE '%GERENTE%') OR
              (UPPER(FUNCOES.NOME_CLH) LIKE '%SUPERVISOR%') OR
              (UPPER(FUNCOES.NOME_CLH) LIKE '%DIRETOR%')) THEN
          1
         ELSE
          0
       END IND_GESTOR,
       ...
       CASE
         WHEN ORG_EMP.COD_NIVEL1 = 1 AND ORG_EMP.COD_ORGANOGRAMA = 1 THEN
          0
         WHEN ORG_EMP.COD_NIVEL2 = 8 AND ORG_EMP.COD_ORGANOGRAMA = 8 THEN
          8
 ...
 INNER JOIN MUNICI MUN ON MUN.COD_MUNIC = FIS.COD_MUNIC
  LEFT JOIN RHFP0310 CONTR_ORGANOGRAMA ON RHFP0300.COD_CONTRATO =
                                          CONTR_ORGANOGRAMA.COD_CONTRATO
                                      AND TRUNC(SYSDATE) BETWEEN
                                          CONTR_ORGANOGRAMA.DATA_INICIO AND
                                          NVL(CONTR_ORGANOGRAMA.DATA_FIM,
                                              TO_DATE('31/12/2999',
                                                      'DD/MM/YYYY'))
  LEFT JOIN RHFP0400 ORGANOGRAMA ON CONTR_ORGANOGRAMA.COD_ORGANOGRAMA =
                                    ORGANOGRAMA.COD_ORGANOGRAMA
  LEFT JOIN RHFP0401 ORG_EMP ON ORGANOGRAMA.COD_ORGANOGRAMA =
                                ORG_EMP.COD_ORGANOGRAMA
                            AND TRUNC(SYSDATE) BETWEEN ORG_EMP.DATA_INICIO AND
                                NVL(ORG_EMP.DATA_FIM,
                                    TO_DATE('31/12/2999', 'DD/MM/YYYY'))
  LEFT JOIN RHFP0340 CONTRFUNC ON RHFP0300.COD_CONTRATO =
                                  CONTRFUNC.COD_CONTRATO
                              AND TRUNC(SYSDATE) BETWEEN
                                  CONTRFUNC.DATA_INICIO AND
                                  NVL(CONTRFUNC.DATA_FIM,
                                      TO_DATE('31/12/2999', 'DD/MM/YYYY'))
  ...
  LEFT JOIN RHAF1119 TURNO ON RHFP0300.COD_CONTRATO = TURNO.COD_CONTRATO
                          AND TRUNC(SYSDATE) BETWEEN TURNO.DATA_INICIO AND
                              TURNO.DATA_FIM
  LEFT JOIN RHFP0307 HORAS ON RHFP0300.COD_CONTRATO = HORAS.COD_CONTRATO
                          AND TRUNC(SYSDATE) BETWEEN HORAS.DATA_INICIO AND
                              HORAS.DATA_FIM
  LEFT JOIN RHFP0321 HORAS2 ON HORAS.COD_HORAS_BASE = HORAS2.COD_HORAS_BASE
  LEFT JOIN RHFP0402 ORG_CUSTO_CTB ON ORGANOGRAMA.COD_CUSTO_CONTABIL =
                                      ORG_CUSTO_CTB.COD_CUSTO_CONTABIL
  LEFT JOIN RHFP0306 AFASTAMENTO ON RHFP0300.COD_CONTRATO =
                                    AFASTAMENTO.COD_CONTRATO
                                AND TRUNC(SYSDATE) BETWEEN
                                    AFASTAMENTO.DATA_INICIO AND
 ...
 WHERE RHFP0200.NRO_SERIE_CTPS IS NOT NULL
   ...
   AND (RHFP0300.DATA_FIM IS NULL AND
       TRUNC(SYSDATE) BETWEEN RHFP0300.DATA_INICIO AND
       NVL(RHFP0300.DATA_FIM, TO_DATE('31/12/2999', 'DD/MM/YYYY')) OR
       RHFP0300.DATA_FIM >= TRUNC(SYSDATE) - 15)
