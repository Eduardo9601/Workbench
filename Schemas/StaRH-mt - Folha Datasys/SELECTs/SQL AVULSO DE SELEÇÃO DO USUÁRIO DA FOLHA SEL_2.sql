...
,CON_FUN.NRO_PIS_PASEP
,CON_FUN.CPF
,CON_FUN.DATA_EXP_CTPS
,CON_FUN.NRO_CTPS
,CON_FUN.NRO_SERIE_CTPS
,CON_FUN.COD_UF_CTPS
,CON_FUN.NRO_IDENTIDADE
,CON_FUN.NOME_UF_IDENTIDADE
,CON_END.NOME_BAIRRO
,CON_END.CEP
,CON_END.COMPLEMENTO
,CON_END.NOME_LOGRA
,CON_END.NOME_MUNIC
,CON_END.NOME_TIP_LOGRA
,CON_END.NUMERO
,CON_END.TIPO_LOGRA
,CON_END.COD_UF
,CON_TURNOS.HORARIO_1_ENT
,CON_TURNOS.HORARIO_2_ENT
,CON_TURNOS.HORARIO_3_ENT
,CON_TURNOS.HORARIO_4_ENT
,CON_TURNOS.HORARIO_1_SAI
,CON_TURNOS.HORARIO_2_SAI
,CON_TURNOS.HORARIO_3_SAI
,CON_TURNOS.HORARIO_4_SAI
,CON_CON.COD_OPC_PGTO
,CON_SIND.IND_CONT_SINDICAL
,CON_DEP.NOME_PESSOA
,CON_DEP.NOME_GRAU_PARENTESCO
,CON_SIND.COD_SINDICATO
,CON_SIND.NOME_SINDICATO
,CON_AVA.DATA_FIM
,CON_AVA.DATA_INICIO
...
SELECT 
  ...
  RHFP0304.DATA_INICIO,     
  RHFP0304.DATA_FIM,  
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_INICIO,'DD')) AS DIA_INICIO,
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_INICIO,'MM')) AS MES_INICIO,
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_INICIO,'YYYY')) AS ANO_INICIO,
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_FIM,'DD')) AS DIA_FIM,
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_FIM,'MM')) AS MES_FIM,
  TO_NUMBER(TO_CHAR(RHFP0304.DATA_FIM,'YYYY')) AS ANO_FIM,
  TO_NUMBER(TRUNC(RHFP0304.DATA_FIM - RHFP0304.DATA_INICIO)+1) AS DIAS_CONTRATO, 
  RHFP0304.COD_TP_CONTRATO,   
  RHFP0304.IND_ENCERRADO, 
  RHFP0305.DATA_AVALIACAO,
  RHFP0305.IND_AVALIACAO,
  RHFP0314.NOME_TP_CONTRATO,
  RHFP0314.COD_TIPO_CONTRATO,
  RHFP0314.NUM_DIAS,
  RHFP0314.IND_AVALIACOES,
  RHFP0314.PROG_AVALIACOES,
...
FROM RHFP0304 RHFP0304,
     ...
     RHFP0314 RHFP0314,
     RHFP0116 RHFP0116   
WHERE :DATA_REFERENCIA BETWEEN RHFP0304.DATA_INICIO AND RHFP0304.DATA_FIM
...
SELECT    
       RHFP0300.COD_CONTRATO,
       PESSOA_FISICA.NOME_LOGRA,
       PESSOA_FISICA.COD_MUNIC,
       PESSOA_FISICA.TIPO_LOGRA,
       PESSOA_FISICA.NOME_TIP_LOGRA,
       PESSOA_FISICA.COD_LOGRA,
       PESSOA_FISICA.COD_BAIRRO,
       PESSOA_FISICA.APELIDO,
       PESSOA_FISICA.FONE_ALTER,
       PESSOA_FISICA.DOC_UNICO,
       PESSOA_FISICA.REFERENCIA,
       PESSOA_FISICA.NUMERO,
       PESSOA_FISICA.COMPLEMENTO,
       PESSOA_FISICA.NOME_BAIRRO,
       PESSOA_FISICA.NOME_MUNIC,
       PESSOA_FISICA.CEP,
       PESSOA_FISICA.COD_UF,
       PESSOA_FISICA.DDD,
       PESSOA_FISICA.FONE,
       PESSOA_FISICA.EMAIL,
       FISICA.EMAIL_ALTER,
       PESSOA_FISICA.FAX,
       PESSOA_FISICA.RAMAL,
       PESSOA_FISICA.DDD_FONE_CEL,
       PESSOA_FISICA.FONE_CEL,
       PESSOA_FISICA.IND_CASA_PROPRIA,
       PESSOA_FISICA.IND_RECURSO_FGTS
FROM RHFP0300 RHFP0300,
     PESSOA_FISICA PESSOA_FISICA,
     FISICA FISICA
WHERE RHFP0300.COD_FUNC = PESSOA_FISICA.COD_PESSOA
  AND PESSOA_FISICA.COD_PESSOA = FISICA.COD_PESSOA(+)
 ) CON_END
,( 
...
( SELECT 
  ...
  DECODE(RHFP0608.TIPO_SALARIO,'M','Mês','H','Hora','') AS NOME_TIPO_SALARIO
 FROM 
  RHFP0608 RHFP0608,
  RHFP0605 RHFP0605,
  RHFP0606 RHFP0606,
  ...
  RHFP0118 RHFP0118
WHERE 
      RHFP0608.COD_INF_SALARIAL = 3
  AND :DATA_REFERENCIA BETWEEN RHFP0608.DATA_INICIO AND RHFP0608.DATA_FIM
  AND RHFP0608.COD_MOTIVO       = RHFP0323.COD_MOTIVO(+)
  AND RHFP0323.COD_TIPO_MOTIVO  = RHFP0115.COD_TIPO_MOTIVO(+)
  AND RHFP0608.COD_INF_SALARIAL = RHFP0118.COD_INF_SALARIAL(+)
  AND RHFP0608.COD_TAB_SALARIAL = RHFP0605.COD_TAB_SALARIAL(+)
  AND RHFP0608.COD_FAIXA        = RHFP0605.COD_FAIXA(+)
  AND RHFP0608.COD_TAB_SALARIAL = RHFP0606.COD_TAB_SALARIAL(+)
  AND RHFP0608.COD_NIVEL        = RHFP0606.COD_NIVEL(+)
  AND RHFP0605.COD_TAB_SALARIAL = RHFP0600_FAIXA.COD_TAB_SALARIAL(+)
  AND RHFP0605.COD_FAIXA        = RHFP0601.COD_FAIXA(+)
  AND RHFP0606.COD_TAB_SALARIAL = RHFP0600_NIVEL.COD_TAB_SALARIAL(+)  
  AND RHFP0606.COD_NIVEL        = RHFP0602.COD_NIVEL(+)  

UNION ALL

SELECT 
  RHFP0608.COD_CONTRATO,
  RHYKUTILS.MAIOR_DATA(RHFP0607.DATA_INICIO,RHFP0608.DATA_INICIO) AS DATA_INICIO_SALARIO,
  RHFP0608.DATA_FIM AS DATA_FIM_SALARIO,
  RHFP0608.COD_MOTIVO,
  RHFP0323.NOME_MOTIVO,
  RHFP0323.COD_TIPO_MOTIVO,
...
WHERE RHFP0608.COD_INF_SALARIAL <> 3
  AND :DATA_REFERENCIA BETWEEN RHFP0608.DATA_INICIO AND RHFP0608.DATA_FIM
  AND RHFP0608.COD_TAB_SALARIAL = RHFP0607.COD_TAB_SALARIAL(+) 
  AND RHFP0608.COD_FAIXA = RHFP0607.COD_FAIXA(+)
  AND RHFP0608.COD_NIVEL = RHFP0607.COD_NIVEL(+)
  AND :DATA_REFERENCIA BETWEEN RHFP0607.DATA_INICIO(+) AND RHFP0607.DATA_FIM(+)
  ...
  AND RHFP0606.COD_TAB_SALARIAL = RHFP0600_NIVEL.COD_TAB_SALARIAL(+)  
  AND RHFP0606.COD_NIVEL        = RHFP0602.COD_NIVEL(+)  
  AND :DATA_REFERENCIA BETWEEN RHFP0600_FAIXA.DATA_INICIO AND RHFP0600_FAIXA.DATA_FIM 
  AND :DATA_REFERENCIA BETWEEN RHFP0600_NIVEL.DATA_INICIO AND RHFP0600_NIVEL.DATA_FIM
) SALARIO
 ) CON_SAL
,( 
...
,( 
SELECT 
  RHFP0312.COD_CONTRATO,
  RHFP0312.DATA_INICIO,
  RHFP0312.DATA_FIM,
  RHFP0312.COD_SINDICATO,
  RHFP0329.COD_PESSOA,
  PESSOA_SIND.NOME_PESSOA AS NOME_SINDICATO,
  JURIDICA.TIP_LOGRA,
  TIPLOG.NOME_TIP_LOGRA,
  LOGRA.NOME_LOGRA,
  JURIDICA.NUMERO,
  JURIDICA.COMPLEMENTO,
  BAIRRO.NOME_BAIRRO,
  MUNICI.NOME_MUNIC,
  JURIDICA.COD_MUNIC,
  JURIDICA.CEP,
  ...
  RHFP0329.COD_BANCO,
  BANCO.COD_FEBRABAN,
  PESSOA_BCO.NOME_PESSOA AS NOME_BANCO_SINDICATO,
  RHFP0329.COD_AGENCIA,
  PESSOA_AGE.NOME_PESSOA AS NOME_AGENCIA_SINDICATO,
  RHFP0329.CTA_CORRENTE,
  RHFP0329.MES_BASE_DISSIDIO,
  RHFP0312.COD_MOTIVO,
  RHFP0323.NOME_MOTIVO,
  RHFP0323.COD_TIPO_MOTIVO,
  RHFP0115.NOME_TIPO_MOTIVO,
  RHFP0312.IND_CONT_SINDICAL,
  RHFP0312.IND_MENS_SINDICATO,
  RHFP0312.IND_CONT_ADMISSAO,
  RHFP0329.COD_ENTIDADE_SIND
FROM
  PESSOA PESSOA_BCO,
  PESSOA PESSOA_AGE,
  PESSOA PESSOA_SIND,
  ...
  RHFP0115 RHFP0115,
  RHFP0329 RHFP0329
WHERE RHFP0312.COD_MOTIVO      = RHFP0323.COD_MOTIVO(+)
  AND RHFP0323.COD_TIPO_MOTIVO = RHFP0115.COD_TIPO_MOTIVO(+)
  AND RHFP0312.COD_SINDICATO   = RHFP0329.COD_SINDICATO(+)
  AND RHFP0329.COD_PESSOA      = PESSOA_SIND.COD_PESSOA(+)
  AND PESSOA_SIND.COD_PESSOA   = JURIDICA.COD_PESSOA(+)
  AND JURIDICA.COD_UF          = MUNICI.COD_UF(+)
  AND JURIDICA.COD_MUNIC       = MUNICI.COD_MUNIC(+)
  AND JURIDICA.COD_UF          = BAIRRO.COD_UF(+)
  AND JURIDICA.COD_MUNIC       = BAIRRO.COD_MUNIC(+)
  AND JURIDICA.COD_BAIRRO      = BAIRRO.COD_BAIRRO(+)
  AND JURIDICA.COD_UF          = LOGRA.COD_UF(+)
  AND JURIDICA.COD_MUNIC       = LOGRA.COD_MUNIC(+)
  AND JURIDICA.COD_LOGRA       = LOGRA.COD_LOGRA(+)
  AND LOGRA.TIP_LOGRA          = TIPLOG.TIP_LOGRA(+)
  AND RHFP0329.COD_BANCO       = BANCO.COD_BANCO(+)
  AND RHFP0329.COD_BANCO       = AGENCIA.COD_BANCO(+)
  AND RHFP0329.COD_AGENCIA     = AGENCIA.COD_AGENCIA(+)
  AND BANCO.COD_PESSOA         = PESSOA_BCO.COD_PESSOA(+)
  AND AGENCIA.COD_PESSOA       = PESSOA_AGE.COD_PESSOA(+)
  AND :DATA_REFERENCIA BETWEEN RHFP0312.DATA_INICIO AND RHFP0312.DATA_FIM
 ) CON_SIND
,( 
SELECT CAMPOS.*
FROM (
...
Where RHFP0300.COD_CONTRATO = CON_AVA.COD_CONTRATO(+)
 ...
 and RHFP0300.COD_CONTRATO = CON_END.COD_CONTRATO(+)
 ...
 and RHFP0300.COD_CONTRATO = CON_SIND.COD_CONTRATO(+)
 ...
 AND ( 
 CON_CON.DATA_INICIO BETWEEN  TO_DATE('01/05/2025','DD/MM/YYYY')  AND  TO_DATE('31/05/2025','DD/MM/YYYY') 
