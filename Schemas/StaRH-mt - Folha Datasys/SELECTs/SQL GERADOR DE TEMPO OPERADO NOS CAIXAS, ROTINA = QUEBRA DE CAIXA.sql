/*SQL GERADOR DE TEMPO OPERADO NOS CAIXAS, ROTINA = QUEBRA DE CAIXA*/

--AJUSTANDO LÓGICA DO SQL PARA QUE POSSA SER GERADO EM UMA TELA NO SISLOGWEB, FAZENDO COM QUE A PLANILHA DISPARADA SEJA EXTINTA E NÃO DISPARADA MAIS AS LOJAS
        ...
        FROM (SELECT A.COD_USUARIO,
               ...
               (SELECT 1
                       ...
                       WHERE Y.COD_FUNCAO IN (225, 120)
                         ...
                         AND Y.COD_CONTRATO = A.COD_USUARIO) -- NÃO IMPORTA HORAS OPERADAS DE VENDEDOR DE MODA MASCULINA DAS FILIAIS FRANCO GIORGI
               GROUP BY A.COD_USUARIO, K.QTD_HORBAS_MES, NMCLH.NOME_CLH, A.COD_UNIDADE) TEMPO,
             RHFP0300 CT
