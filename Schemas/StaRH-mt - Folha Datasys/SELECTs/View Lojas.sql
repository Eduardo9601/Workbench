...
FILTRO_TELEFONES_2 AS (
    SELECT COD_PESSOA, NUM_FONE AS TEL_FIXO
    FROM NL.PS_TELEFONES@NLGRZ
    WHERE NUM_SEQ = 2
)
SELECT
...
LEFT JOIN FILTRO_TELEFONES_2 TEL2 ON PSPES.COD_PESSOA = TEL2.COD_PESSOA
...
LEFT JOIN GRAZZ.GRZ_UNIDADES@NLGRZ AREA ON GU.COD_UNIDADE = AREA.COD_UNIDADE
WHERE GU.COD_EMP = 1
