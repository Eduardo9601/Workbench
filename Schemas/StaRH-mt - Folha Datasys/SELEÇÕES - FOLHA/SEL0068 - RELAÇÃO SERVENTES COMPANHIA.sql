...
SELECT A.COD_CONTRATO,
       ...
       A.DATA_DEMISSAO,
       A.DES_FUNCAO,
       TO_CHAR(C.SAL_ATUAL, 'FM999G999G990D00') AS SALARIO_BRUTO,
       A.HR_BASE_MES,
       A.HR_BASE_SEM,
       A.HR_BASE_DIA,
       A.DES_UNIDADE,
...
SELECT
   ...
   NULL AS DES_FUNCAO,
   TO_CHAR(SUM(C.SAL_ATUAL), 'FM999G999G990D00') AS SALARIO_BRUTO,
   NULL AS HR_BASE_MES,
   NULL AS HR_BASE_SEM,
   NULL AS HR_BASE_DIA,
   NULL AS DES_UNIDADE,
...
ORDER BY IDADE DESC NULLS LAST, DES_UNIDADE
