...
SELECT COD_CONTRATO,
 ...
 WHERE DATA_ADMISSAO BETWEEN :DEMISSAO_INICIO AND :DEMISSAO_FIM
   AND COD_EMP = 4
   AND STATUS = 1
...
SELECT A.COD_CONTRATO,
 ...
 WHERE A.COD_MOTIVO = B.COD_MOTIVO(+)
   ...
   AND :DEMISSAO_FIM BETWEEN A.DATA_INICIO AND A.DATA_FIM
...
FROM RHFP0304 RHFP0304,
     ...
     RHFP0314 RHFP0314,
     RHFP0116 RHFP0116
WHERE :DEMISSAO_FIM BETWEEN RHFP0304.DATA_INICIO AND RHFP0304.DATA_FIM
...
FROM RHFP0608
WHERE :DEMISSAO_FIM BETWEEN DATA_INICIO AND DATA_FIM
--AND COD_CONTRATO = 397017
  ...
  FROM RHFP1006 RHFP1006,
       (SELECT RHFP1003.COD_MESTRE_EVENTO,
         ...
         WHERE RHFP1003.SITUACAO_PROCESSO = 'I'
           ...
           AND RHFP1003.DATA_REFERENCIA BETWEEN :DEMISSAO_INICIO AND
               :DEMISSAO_FIM) MESTRE
...
SELECT RHFP0300.COD_CONTRATO,
       ...
       TRUNC(MONTHS_BETWEEN(:DEMISSAO_FIM, RHFP0202.DATA_NASCIMENTO) / 12) AS IDADE_DEPEN
  FROM FISICA   FISICA,
       PESSOA   PESSOA,
       RHFP0300 RHFP0300,
       RHFP0202 RHFP0202,
 ...
 WHERE RHFP0202.COD_FUNC = RHFP0300.COD_FUNC
   ...
   AND :DEMISSAO_FIM BETWEEN RHFP0202.DATA_INICIO AND RHFP0202.DATA_FIM
