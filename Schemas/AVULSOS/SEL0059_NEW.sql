...
/*VERSÃƒO PARA INFORMAR AS DATAS
SELECT
...
SELECT DISTINCT
 ...
 WHERE CT.COD_CONTRATO = AF.COD_CONTRATO(+)
   ...
   AND ORG.COD_UNIDADE NOT IN (014, 050, 615, 657, 7586, 7608)
   AND ORG.COD_TIPO = 1
   --AND ORG.COD_UNIDADE NOT IN (014, 050, 615, 657, 7586, 7608) --657 essa ainda irÃ¡ inaugurar em agosto
),



/*==== RELAÃ‡ÃƒO DOS KPIs MAIS RELEVANTES - POR UNIDADE====*/
...
SELECT A.COD_ORGANOGRAMA,
       ...
       A.COD_TIPO,
       SUM(CASE
             WHEN A.IND_DEFICIENCIA = 'S' AND A.HR_BASE_MES > 120 THEN -- Corrigido para contar PCD > 120
