...
SELECT X.EMPRESA,
       ...
       x.COD_4082,
       x.NOME_4082,
       TO_CHAR(x.VALOR_4082, 'FM999G999G990D00') AS VALOR_4082,

       x.COD_4084,
       x.NOME_4084,
       TO_CHAR(x.VALOR_4084, 'FM999G999G990D00') AS VALOR_4084,

       x.COD_4085,
       x.NOME_4085,
       TO_CHAR(x.VALOR_4085, 'FM999G999G990D00') AS VALOR_4085,

       x.COD_4086,
       x.NOME_4086,
       TO_CHAR(x.VALOR_4086, 'FM999G999G990D00') AS VALOR_4086,

       x.COD_4087,
       x.NOME_4087,
       TO_CHAR(x.VALOR_4087, 'FM999G999G990D00') AS VALOR_4087,

       x.COD_4088,
       x.NOME_4088,
       TO_CHAR(x.VALOR_4088, 'FM999G999G990D00') AS VALOR_4088,

       x.COD_4089,
       x.NOME_4089,
       TO_CHAR(x.VALOR_4089, 'FM999G999G990D00') AS VALOR_4089,

       x.COD_4090,
       x.NOME_4090,
       TO_CHAR(x.VALOR_4090, 'FM999G999G990D00') AS VALOR_4090,

       x.COD_4091,
       x.NOME_4091,
       TO_CHAR(x.VALOR_4091, 'FM999G999G990D00') AS VALOR_4091,

       x.COD_4092,
       x.NOME_4092,
       TO_CHAR(x.VALOR_4092, 'FM999G999G990D00') AS VALOR_4092,
  ...
  FROM (
        SELECT EMPRESA,
               ...
               /* 4075 */
               V4082_COD AS COD_4082,
               V4082_NOME AS NOME_4082,
               NVL(V4082_VALOR, 0) AS VALOR_4082,

               /* 4096 */
               V4084_COD AS COD_4084,
               V4084_NOME AS NOME_4084,
               NVL(V4084_VALOR, 0) AS VALOR_4084,

               /* 4097 */
               V4085_COD AS COD_4085,
               V4085_NOME AS NOME_4085,
               NVL(V4085_VALOR, 0) AS VALOR_4085,

               /* 4098 */
               V4086_COD AS COD_4086,
               V4086_NOME AS NOME_4086,
               NVL(V4086_VALOR, 0) AS VALOR_4086,

               /* 4099 */
               V4087_COD AS COD_4087,
               V4087_NOME AS NOME_4087,
               NVL(V4087_VALOR, 0) AS VALOR_4087,

               /* 4100 */
               V4088_COD AS COD_4088,
               V4088_NOME AS NOME_4088,
               NVL(V4088_VALOR, 0) AS VALOR_4088,

               /* 4101 */
               V4089_COD AS COD_4089,
               V4089_NOME AS NOME_4089,
               NVL(V4089_VALOR, 0) AS VALOR_4089,

               /* 4102 */
               V4090_COD AS COD_4090,
               V4090_NOME AS NOME_4090,
               NVL(V4090_VALOR, 0) AS VALOR_4090,

               /* 4103 */
               V4091_COD AS COD_4091,
               V4091_NOME AS NOME_4091,
               NVL(V4091_VALOR, 0) AS VALOR_4091,

               /* 4104 */
               V4092_COD AS COD_4092,
               V4092_NOME AS NOME_4092,
               NVL(V4092_VALOR, 0) AS VALOR_4092,

               /* total por linha (opcional) */
               NVL(V4082_VALOR, 0) + NVL(V4084_VALOR, 0) +
               NVL(V4085_VALOR, 0) + NVL(V4086_VALOR, 0) +
               NVL(V4087_VALOR, 0) + NVL(V4088_VALOR, 0) +
               NVL(V4089_VALOR, 0) + NVL(V4090_VALOR, 0) +
               NVL(V4091_VALOR, 0) + NVL(V4092_VALOR, 0) AS TOTAL,
          ...
          FROM (SELECT VE.EMPRESA || ' - ' || CT.DES_EMP AS EMPRESA,
                  ...
                  WHERE VE.COD_VD IN
                        (4082, 4084, 4085, 4086, 4087, 4088, 4089, 4090, 4091, 4092)
                        )
                         PIVOT(SUM(VALOR_VD) AS VALOR,
                               MAX(NOME_VD) AS NOME,
                               MAX(COD_VD_MEDIDA)
                               AS COD FOR COD_VD IN (4082 AS V4082, 4084 AS V4084,
                                                     4085 AS V4085, 4086 AS V4086,
                                                     4087 AS V4087, 4088 AS V4088,
                                                     4089 AS V4089, 4090 AS V4090,
                                                     4091 AS V4091, 4092 AS V4092))) X
