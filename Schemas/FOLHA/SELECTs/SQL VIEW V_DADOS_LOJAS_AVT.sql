CREATE OR REPLACE VIEW V_DADOS_LOJAS_AVT AS
  ...
  /******************************************/
  /****   VERSÃO: 2.3                    ****/
  /****   CRIADO POR: EDUARDO AP         ****/
  /****   ANTERADO POR: EDUARDO AP       ****/
  /****   DATA DA CRIAÇÃO: 28/08/2023    ****/
  /****   DATA DA ALTERAÇÃO: 19/09/2023  ****/
  /******************************************/
  /******************************************/
...
SELECT
    ...
    LOJASATV.REDE,
    LOJASATV.DES_REDE,
    LOJASATV.EDICAO_NIVEL2 AS EMPRESA,
    LOJASATV.EMAIL,
    LOJASATV.CELULAR,
...
FROM (
    ...
    INNER JOIN RHFP0310 B1 ON B1.COD_ORGANOGRAMA = A1.COD_ORGANOGRAMA
    INNER JOIN JURIDICA J ON J.CGC = UNI.NUM_CGC
    INNER JOIN PE0002 PE ON PE.COD_PESSOA = J.COD_PESSOA
