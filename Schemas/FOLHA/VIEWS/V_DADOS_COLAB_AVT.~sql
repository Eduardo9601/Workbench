...
SELECT CASE
       ...
       G.COD_ESOCIAL,
       A.NRO_CONTA_PGTO || '/' || A.COD_AGE_PGTO AS CONTA_BANCARIA,
 ...
 WHERE ((A.DATA_FIM IS NULL OR
       SYSDATE BETWEEN A.DATA_INICIO AND
