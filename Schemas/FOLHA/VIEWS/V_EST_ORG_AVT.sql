...
SELECT DISTINCT
       ...
       C.EDICAO_NIVEL3,
       CASE
           WHEN C.EDICAO_NIVEL3 = '1' AND A.COD_ORGANOGRAMA <> 1 AND A.EDICAO_ORG NOT IN ('811', '815') AND B.COD_NIVEL_ORG = 5 THEN
            '10'
           WHEN C.EDICAO_NIVEL3 = '3' AND A.EDICAO_ORG NOT IN ('831', '835') AND B.COD_NIVEL_ORG = 5 THEN
            '30'
           WHEN C.EDICAO_NIVEL3 = '4' AND A.EDICAO_ORG NOT IN ('841', '845') AND B.COD_NIVEL_ORG = 5 THEN
            '40'
           WHEN C.EDICAO_NIVEL3 = '2' AND A.EDICAO_ORG NOT IN ('851', '855') AND B.COD_NIVEL_ORG = 5 THEN
            '50'
           WHEN C.EDICAO_NIVEL3 = '7' AND A.EDICAO_ORG NOT IN ('871') AND B.COD_NIVEL_ORG = 5 THEN
            '70'
